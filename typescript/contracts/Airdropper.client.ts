...
export interface AirdropperInterface extends AirdropperReadOnlyInterface {
  ...
  markTokenIDClaimed: (fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
...
export class AirdropperClient extends AirdropperQueryClient implements AirdropperInterface {
  ...
  markTokenIDClaimed = async (fee: number | StdFee | "auto" = "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
